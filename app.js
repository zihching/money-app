...
// 清除日期按鈕功能
window.clearSettleDates = function() {
    document.getElementById('settleStartDate').value = '';
    document.getElementById('settleEndDate').value = '';
...
window.onload = function() {
    ...
    // 初始化時，設置結算日期為本月第一天到今天
    // (可選：如果你希望預設看到所有，可以把下面這兩行註解掉)
